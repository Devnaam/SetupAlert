      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
        ...
        <div className="flex-1 min-w-0 space-y-3">
          ...
          <div className="flex items-center gap-3">
            <h3 className="text-lg font-semibold text-white">{symbolLabel}</h3>
            <Badge
          ...
          <div className="flex flex-wrap gap-2">
            {alert.price_level && (
              <span className="inline-flex items-center px-2.5 py-1 rounded-lg bg-cyan-500/10 text-cyan-400 text-xs font-medium border border-cyan-500/20">
                ${alert.price_level.toLocaleString()}
              </span>
            )}
            {patternLabel && (
              <span className="inline-flex items-center px-2.5 py-1 rounded-lg bg-violet-500/10 text-violet-400 text-xs font-medium border border-violet-500/20">
                {patternLabel}
              </span>
            )}
            <span className="inline-flex items-center px-2.5 py-1 rounded-lg bg-white/5 text-gray-400 text-xs font-medium border border-white/10">
              {timeframeLabel}
            </span>
          </div>
