...
export default function LoginPage() {
 ...
 <div className="absolute top-1/4 -left-32 w-96 h-96 rounded-full bg-brand/10 blur-[120px] animate-pulse-glow" />
 <div className="absolute bottom-1/4 -right-32 w-96 h-96 rounded-full bg-brand/10 blur-[120px] animate-pulse-glow" />
